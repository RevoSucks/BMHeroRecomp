...
[Bomberman Hero: Recompiled](https://github.com/RevoSucks/BMHeroRecomp) is a project that uses [N64: Recompiled](https://github.com/Mr-Wiseguy/N64Recomp) to **statically recompile** Bomberman Hero into a native port with many new features, enhancements, and extensive mod support. This project uses [RT64](https://github.com/rt64/rt64) as the rendering engine to provide some of these enhancements.
...
* [Bomberman Hero Decompilation](https://github.com/bomberhackers/bmhero) for headers and some function definitions, used for making patches or some enhancements
