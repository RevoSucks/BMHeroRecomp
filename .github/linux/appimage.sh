...
./deploy/AppRun --appdir=AppDir/ -d AppDir/BMHeroRecompiled.desktop -i AppDir/BMHeroRecompiled.png -e AppDir/usr/bin/BMHeroRecompiled --plugin gtk
...
echo '    APP_FOLDER_PATH=$APP_FOLDER_PATH ./BMHeroRecompiled' >> AppDir/AppRun
echo 'else' >> AppDir/AppRun
echo '    cd "$this_dir"/usr/bin/' >> AppDir/AppRun
echo '    ./BMHeroRecompiled' >> AppDir/AppRun
